...
<?php 
$artid = $_GET['artid'];
$row = mysqli_query($konekcija, "select * from top_movies WHERE id=$artid");
...
echo    "<div class='6u'>
			<div class='mobileUI-main-content' id='content'>
				<section>
					<div class='post'>
						...
						<p><a href='#'><img class='img-thumbnail' src='images/pics06.jpg' height='300' width='588' alt=''></a><br>
		...
		<div class='3u' id='sidebar1'>
			<section>
				...
				<ul class='style2'>
					<li class='first'>
						<p><a href='#'><img class='img-rounded' src='images/pics07.jpg' height='80' width='80' alt=''><h4>TOP MOVIE OF THE MONTH IN SCI FI</h4></a><br>{$res->description_no2}</p>
					</li>
					<li>
						<p><a href='#'><img class='img-rounded' src='images/pics08.jpg' height='80' width='80' alt=''><h4>TOP MOVIE OF THE MONTH IN COMEDY</h4></a><br>{$res->description_no3}</p>
					</li>
					<li>
						<p><a href='#'><img class='img-rounded' src='images/pics09.jpg' height='80' width='80' alt=''><h4>TOP MOVIE OF THE MONTH IN HORROR</h4></a><br>{$res->description_no4}</p>
					</li>
					<li>
						<p><a href='#'><img class='img-rounded' src='images/pics10.jpg' height='80' width='80' alt=''><h4>TOP MOVIE OF THE MONTH IN DRAMA</h4></a><br>{$res->description_no5}</p>
					</li>
				</ul>
			</section>
	</div>";
